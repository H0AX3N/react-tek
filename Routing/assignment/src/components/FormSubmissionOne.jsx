...
function FormSubmissionOne() {
    ...
    const buttonStyle = 'flex items-center justify-center bg-[#FAF7F5] text-black rounded-lg py-2 px-4 cursor-pointer flex-grow hover:bg-[#FBE7E9] transition-colors duration-300'
    ...
    return (
        <div className='flex flex-col items-center justify-center'>
            <form className='flex flex-col gap-4 p-4 rounded-2xl' onSubmit={formik.handleSubmit}>
                <div>
                    <input
                        type="text"
                        name='fullName'
