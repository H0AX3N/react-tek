...
function Products() {
    ...
    return (
        <div className='flex flex-col items-center justify-center bg-gray-100 p-4 m-2 w-[80vw] rounded-xl'>
            {products.map((product) => (
                <ul key={product.id} className='flex flex-col items-center justify-center bg-gray-200 p-4 m-2 w-2xl rounded-xl'>
